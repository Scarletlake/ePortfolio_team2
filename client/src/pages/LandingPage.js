        ...
        <div className='LandingBlock'>
          ...
          <div className={classes.team}>
            ...
            <Grid id="team" container style={{ marginTop: 20, }} >
              ...
              <Grid item xs={4} className={classes.member} container>
                <Grid item xs={12}><img src="/ou.jpg" alt="ouyang" style={{ height: 150, width: 150, borderRadius: "50%" }} /></Grid>
                <Grid item xs={12}><Typography variant="h6">Ouyang Hui</Typography></Grid>
              </Grid>

              <Grid item xs={4} className={classes.member} container>
                <Grid item xs={12}><img src="/JielinZheng.jpg" alt="jielin" style={{ height: 150, width: 150, borderRadius: "50%" }} /></Grid>
              ...
              <Grid item xs={4} className={classes.member} container>
                <Grid item xs={12}><img src="/ZhuolunWu.png" alt="zhuolun" style={{ height: 150, width: 150, borderRadius: "50%" }} /></Grid>
                <Grid item xs={12}><Typography variant="h6">Zhuolun Wu</Typography></Grid>
              </Grid>

              <Grid item xs={4} className={classes.member} container>
                <Grid item xs={12}><img src="/JiashuaiYu.jpg" alt="jiashuai" style={{ height: 150, width: 150, borderRadius: "50%" }} /></Grid>
