...
import MinimalPortfolioSection from './MinimalPortfolioSection.js';
...
export default function MinimalPortfolio(props) {
    ...
    <div className='PageContainer'>
      ...
      <div className='PortfolioForm TextCenter VerticalAlign PortfolioBackgroundWrap'>
        ...
        <div className='TextCenter VerticalAlign'>
          ...
          <MinimalPortfolioSection sections={portfolio.formalPage.sections} />
        </div>
        </TabPanel>
        ...
        <div className='TextCenter VerticalAlign'>
          ...
          <MinimalPortfolioSection sections={portfolio.leisurePage.sections} />
        </div>
        </TabPanel>
