...
import BusinessPortfolioSection from './BusinessPortfolioSection.js';
...
export default function BusinessPortfolio(props) {
    ...
    <div className='PageContainer'>
      ...
      <div className='PortfolioForm TextCenter VerticalAlign PortfolioBackgroundWrap'>
        ...
        <div className='TextCenter VerticalAlign'>
          ...
          <BusinessPortfolioSection sections={portfolio.formalPage.sections} />
        </div>
        </TabPanel>
        ...
        <div className='TextCenter VerticalAlign'>
          ...
          <BusinessPortfolioSection sections={portfolio.leisurePage.sections} />
        </div>
        </TabPanel>
